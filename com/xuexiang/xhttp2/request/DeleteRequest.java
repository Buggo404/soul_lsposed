...
public class DeleteRequest extends com.xuexiang.xhttp2.request.BaseBodyRequest<com.xuexiang.xhttp2.request.DeleteRequest> {
    public DeleteRequest(java.lang.String r1) {
            r0 = this;
            r0.<init>(r1)
            return
    }
    ...
    protected io.reactivex.Observable<okhttp3.ResponseBody> generateRequest() {
            ...
            io.reactivex.Observable r0 = r0.deleteBody(r1, r2)
            return r0
        L11:
            ...
            io.reactivex.Observable r0 = r1.deleteJson(r2, r0)
            return r0
        L2c:
        ...
        L3d:
            ...
            com.xuexiang.xhttp2.api.ApiService r1 = r3.mApiManager
            java.lang.String r2 = r3.getUrl()
            io.reactivex.Observable r0 = r1.deleteBody(r2, r0)
            return r0
        L54:
            com.xuexiang.xhttp2.api.ApiService r0 = r3.mApiManager
            java.lang.String r1 = r3.getUrl()
            ...
            io.reactivex.Observable r0 = r0.delete(r1, r2)
            return r0
    }
}
