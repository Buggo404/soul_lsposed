...
public final class FlowableConcatMapSingle<T, R> extends io.reactivex.Flowable<R> {
    ...
    static final class ConcatMapSingleSubscriber<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.FlowableSubscriber<T>, org.reactivestreams.Subscription {
        ...
        final io.reactivex.internal.operators.mixed.FlowableConcatMapSingle.ConcatMapSingleSubscriber.ConcatMapSingleObserver<R> inner;
        R item;
        final io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> mapper;
        final int prefetch;
        ...
        static final class ConcatMapSingleObserver<R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.SingleObserver<R> {
            ...
            final io.reactivex.internal.operators.mixed.FlowableConcatMapSingle.ConcatMapSingleSubscriber<?, R> parent;

            ConcatMapSingleObserver(io.reactivex.internal.operators.mixed.FlowableConcatMapSingle.ConcatMapSingleSubscriber<?, R> r1) {
                    r0 = this;
                    r0.<init>()
                    r0.parent = r1
                    return
            ...
            public void onError(java.lang.Throwable r2) {
                    r1 = this;
                    io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber<?, R> r0 = r1.parent
                    r0.innerError(r2)
                    return
            }
        ...
        ConcatMapSingleSubscriber(org.reactivestreams.Subscriber<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2, int r3, io.reactivex.internal.util.ErrorMode r4) {
                r0 = this;
                r0.<init>()
                r0.downstream = r1
                r0.mapper = r2
                ...
                r1.<init>()
                r0.errors = r1
                io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber$ConcatMapSingleObserver r1 = new io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber$ConcatMapSingleObserver
                r1.<init>(r0)
                r0.inner = r1
        ...
        public void cancel() {
                ...
                r0.cancel()
                io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber$ConcatMapSingleObserver<R> r0 = r1.inner
                r0.dispose()
        ...
        public void onError(java.lang.Throwable r2) {
                ...
                if (r2 != r0) goto L13
                io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber$ConcatMapSingleObserver<R> r2 = r1.inner
                r2.dispose()
            L13:
                r2 = 1
                r1.done = r2
    ...
    public FlowableConcatMapSingle(io.reactivex.Flowable<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2, io.reactivex.internal.util.ErrorMode r3, int r4) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super R> r6) {
            ...
            io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber r1 = new io.reactivex.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber
