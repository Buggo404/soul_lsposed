...
public final class ObservableFromPublisher<T> extends io.reactivex.Observable<T> {
    ...
    static final class PublisherSubscriber<T> implements io.reactivex.FlowableSubscriber<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        org.reactivestreams.Subscription f412s;

        PublisherSubscriber(io.reactivex.Observer<? super T> r1) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                return
        ...
        public void dispose() {
                r1 = this;
                org.reactivestreams.Subscription r0 = r1.f412s
                r0.cancel()
        ...
        public boolean isDisposed() {
                r2 = this;
                org.reactivestreams.Subscription r0 = r2.f412s
    ...
    public ObservableFromPublisher(org.reactivestreams.Publisher<? extends T> r1) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            return
    ...
    protected void subscribeActual(io.reactivex.Observer<? super T> r3) {
            r2 = this;
            org.reactivestreams.Publisher<? extends T> r0 = r2.source
            io.reactivex.internal.operators.observable.ObservableFromPublisher$PublisherSubscriber r1 = new io.reactivex.internal.operators.observable.ObservableFromPublisher$PublisherSubscriber
            r1.<init>(r3)
            r0.subscribe(r1)
            return
    }
