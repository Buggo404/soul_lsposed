...
public final class ObservableToListSingle<T, U extends java.util.Collection<? super T>> extends io.reactivex.Single<U> implements io.reactivex.internal.fuseable.FuseToObservable<U> {
    ...
    static final class ToListObserver<T, U extends java.util.Collection<? super T>> implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        io.reactivex.disposables.Disposable f463s;

        ToListObserver(io.reactivex.SingleObserver<? super U> r1, U r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.collection = r2
        ...
        public void dispose() {
                r1 = this;
                io.reactivex.disposables.Disposable r0 = r1.f463s
                r0.dispose()
                return
        }
        ...
        public void onComplete() {
                ...
                r1 = 0
                r2.collection = r1
                io.reactivex.SingleObserver<? super U extends java.util.Collection<? super T>> r1 = r2.actual
                r1.onSuccess(r0)
                return
        }
        ...
        public void onSubscribe(io.reactivex.disposables.Disposable r2) {
                ...
                if (r0 == 0) goto Lf
                r1.f463s = r2
                io.reactivex.SingleObserver<? super U extends java.util.Collection<? super T>> r2 = r1.actual
                r2.onSubscribe(r1)
            Lf:
                return
        }
    ...
    public ObservableToListSingle(io.reactivex.ObservableSource<T> r1, int r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
    ...
    public ObservableToListSingle(io.reactivex.ObservableSource<T> r1, java.util.concurrent.Callable<U> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
    ...
    public void subscribeActual(io.reactivex.SingleObserver<? super U> r4) {
            r3 = this;
            ...
            io.reactivex.ObservableSource<T> r1 = r3.source
            io.reactivex.internal.operators.observable.ObservableToListSingle$ToListObserver r2 = new io.reactivex.internal.operators.observable.ObservableToListSingle$ToListObserver
            r2.<init>(r4, r0)
            r1.subscribe(r2)
            return
        L19:
