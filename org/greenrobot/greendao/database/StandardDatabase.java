...
public class StandardDatabase implements org.greenrobot.greendao.database.Database {
    private final android.database.sqlite.SQLiteDatabase delegate;

    public StandardDatabase(android.database.sqlite.SQLiteDatabase r1) {
            r0 = this;
            r0.<init>()
            r0.delegate = r1
            return
    ...
    public org.greenrobot.greendao.database.DatabaseStatement compileStatement(java.lang.String r3) {
            r2 = this;
            org.greenrobot.greendao.database.StandardDatabaseStatement r0 = new org.greenrobot.greendao.database.StandardDatabaseStatement
            android.database.sqlite.SQLiteDatabase r1 = r2.delegate
