...
public final class MaybeFlatMapSingleElement<T, R> extends io.reactivex.Maybe<R> {
    ...
    static final class FlatMapMaybeObserver<T, R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable {
        ...
        FlatMapMaybeObserver(io.reactivex.MaybeObserver<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void onSuccess(T r3) {
                r2 = this;
                io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r0 = r2.mapper     // Catch: java.lang.Throwable -> L19
                ...
                io.reactivex.SingleSource r3 = (io.reactivex.SingleSource) r3     // Catch: java.lang.Throwable -> L19
                io.reactivex.internal.operators.maybe.MaybeFlatMapSingleElement$FlatMapSingleObserver r0 = new io.reactivex.internal.operators.maybe.MaybeFlatMapSingleElement$FlatMapSingleObserver
    ...
    static final class FlatMapSingleObserver<R> implements io.reactivex.SingleObserver<R> {
        ...
        FlatMapSingleObserver(java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r1, io.reactivex.MaybeObserver<? super R> r2) {
                r0 = this;
                r0.<init>()
                r0.parent = r1
                r0.actual = r2
    ...
    public MaybeFlatMapSingleElement(io.reactivex.MaybeSource<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super R> r4) {
            ...
            io.reactivex.internal.operators.maybe.MaybeFlatMapSingleElement$FlatMapMaybeObserver r1 = new io.reactivex.internal.operators.maybe.MaybeFlatMapSingleElement$FlatMapMaybeObserver
