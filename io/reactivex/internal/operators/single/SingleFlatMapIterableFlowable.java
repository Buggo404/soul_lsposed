...
public final class SingleFlatMapIterableFlowable<T, R> extends io.reactivex.Flowable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends io.reactivex.internal.subscriptions.BasicIntQueueSubscription<R> implements io.reactivex.SingleObserver<T> {
        ...
        /* renamed from: d */
        io.reactivex.disposables.Disposable f509d;

        /* renamed from: it */
        volatile java.util.Iterator<? extends R> f510it;
        final io.reactivex.functions.Function<? super T, ? extends java.lang.Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void cancel() {
                ...
                r0 = 1
                r1.cancelled = r0
                io.reactivex.disposables.Disposable r0 = r1.f509d
                r0.dispose()
        ...
        void drain() {
            ...
            L7:
                ...
                java.util.Iterator<? extends R> r1 = r11.f510it
        ...
        public boolean isEmpty() {
                r1 = this;
                java.util.Iterator<? extends R> r0 = r1.f510it
                if (r0 != 0) goto L6
                r0 = 1
                goto L7
            L6:
        ...
        public R poll() throws java.lang.Exception {
                r4 = this;
                java.util.Iterator<? extends R> r0 = r4.f510it
                r1 = 0
                if (r0 == 0) goto L18
        ...
        void slowPath(org.reactivestreams.Subscriber<? super R> r2, java.util.Iterator<? extends R> r3) {
                r1 = this;
            L0:
    ...
    public SingleFlatMapIterableFlowable(io.reactivex.SingleSource<T> r1, io.reactivex.functions.Function<? super T, ? extends java.lang.Iterable<? extends R>> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super R> r4) {
            ...
            io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable$FlatMapIterableObserver r1 = new io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable$FlatMapIterableObserver
