...
class AndroidResources {
    ...
    static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE = null;
    static final int STYLEABLE_ANIMATED_VECTOR_DRAWABLE_DRAWABLE = 0;
    static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = null;
    ...
    public static final int[] STYLEABLE_ANIMATOR = null;
    ...
    public static final int[] STYLEABLE_ANIMATOR_SET = null;
    ...
    public static final int[] STYLEABLE_KEYFRAME = null;
    ...
    public static final int[] STYLEABLE_PATH_INTERPOLATOR = null;
    ...
    public static final int[] STYLEABLE_PROPERTY_ANIMATOR = null;
    ...
    public static final int[] STYLEABLE_PROPERTY_VALUES_HOLDER = null;
    ...
    static final int[] STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = null;
    ...
    static final int[] STYLEABLE_VECTOR_DRAWABLE_GROUP = null;
    ...
    static final int[] STYLEABLE_VECTOR_DRAWABLE_PATH = null;
    ...
    static final int[] STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = null;
    ...
    static {
            r0 = 9
            int[] r0 = new int[r0]
            r0 = {x0066: FILL_ARRAY_DATA , data: [16842755, 16843041, 16843093, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = r0
            r0 = 8
            int[] r1 = new int[r0]
            r1 = {x007c: FILL_ARRAY_DATA , data: [16842755, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_GROUP = r1
            r1 = 14
            int[] r1 = new int[r1]
            r1 = {x0090: FILL_ARRAY_DATA , data: [16842755, 16843780, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980, 16844062} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_PATH = r1
            r1 = 3
            int[] r1 = new int[r1]
            r1 = {x00b0: FILL_ARRAY_DATA , data: [16842755, 16843781, 16844062} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = r1
            r1 = 1
            int[] r2 = new int[r1]
            r3 = 16843161(0x1010199, float:2.3694704E-38)
            r4 = 0
            r2[r4] = r3
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE = r2
            r2 = 2
            int[] r2 = new int[r2]
            r2 = {x00ba: FILL_ARRAY_DATA , data: [16842755, 16843213} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = r2
            int[] r0 = new int[r0]
            r0 = {x00c2: FILL_ARRAY_DATA , data: [16843073, 16843160, 16843198, 16843199, 16843200, 16843486, 16843487, 16843488} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATOR = r0
            int[] r0 = new int[r1]
            r1 = 16843490(0x10102e2, float:2.3695626E-38)
            r0[r4] = r1
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATOR_SET = r0
            r0 = 4
            int[] r1 = new int[r0]
            r1 = {x00d6: FILL_ARRAY_DATA , data: [16843486, 16843487, 16843488, 16843489} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER = r1
            int[] r1 = new int[r0]
            r1 = {x00e2: FILL_ARRAY_DATA , data: [16842788, 16843073, 16843488, 16843992} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_KEYFRAME = r1
            int[] r0 = new int[r0]
            r0 = {x00ee: FILL_ARRAY_DATA , data: [16843489, 16843781, 16843892, 16843893} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_PROPERTY_ANIMATOR = r0
            r0 = 5
            int[] r0 = new int[r0]
            r0 = {x00fa: FILL_ARRAY_DATA , data: [16843772, 16843773, 16843774, 16843775, 16843781} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_PATH_INTERPOLATOR = r0
            return
    }
