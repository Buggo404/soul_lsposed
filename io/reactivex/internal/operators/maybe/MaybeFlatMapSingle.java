...
public final class MaybeFlatMapSingle<T, R> extends io.reactivex.Single<R> {
    ...
    static final class FlatMapMaybeObserver<T, R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable {
        ...
        FlatMapMaybeObserver(io.reactivex.SingleObserver<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void onSuccess(T r3) {
                ...
                if (r0 != 0) goto L1e
                io.reactivex.internal.operators.maybe.MaybeFlatMapSingle$FlatMapSingleObserver r0 = new io.reactivex.internal.operators.maybe.MaybeFlatMapSingle$FlatMapSingleObserver
    ...
    public MaybeFlatMapSingle(io.reactivex.MaybeSource<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(io.reactivex.SingleObserver<? super R> r4) {
            ...
            io.reactivex.internal.operators.maybe.MaybeFlatMapSingle$FlatMapMaybeObserver r1 = new io.reactivex.internal.operators.maybe.MaybeFlatMapSingle$FlatMapMaybeObserver
