...
public final class ParallelReduce<T, R> extends io.reactivex.parallel.ParallelFlowable<R> {
    ...
    static final class ParallelReduceSubscriber<T, R> extends io.reactivex.internal.subscribers.DeferredScalarSubscriber<T, R> {
        ...
        ParallelReduceSubscriber(org.reactivestreams.Subscriber<? super R> r1, R r2, io.reactivex.functions.BiFunction<R, ? super T, R> r3) {
                r0 = this;
                r0.<init>(r1)
                r0.accumulator = r2
                r0.reducer = r3
        ...
        public void onNext(T r3) {
                ...
                boolean r0 = r2.done
                if (r0 != 0) goto L1f
                io.reactivex.functions.BiFunction<R, ? super T, R> r0 = r2.reducer     // Catch: java.lang.Throwable -> L15
                R r1 = r2.accumulator     // Catch: java.lang.Throwable -> L15
                java.lang.Object r3 = r0.apply(r1, r3)     // Catch: java.lang.Throwable -> L15
                java.lang.String r0 = "The reducer returned a null value"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r3, r0)     // Catch: java.lang.Throwable -> L15
                r2.accumulator = r3
                goto L1f
            L15:
                r3 = move-exception
    ...
    public ParallelReduce(io.reactivex.parallel.ParallelFlowable<? extends T> r1, java.util.concurrent.Callable<R> r2, io.reactivex.functions.BiFunction<R, ? super T, R> r3) {
            r0 = this;
            r0.<init>()
            r0.source = r1
    ...
    public void subscribe(org.reactivestreams.Subscriber<? super R>[] r8) {
        ...
        Lb:
            if (r2 >= r0) goto L2f
            java.util.concurrent.Callable<R> r3 = r7.initialSupplier     // Catch: java.lang.Throwable -> L27
            ...
            io.reactivex.internal.operators.parallel.ParallelReduce$ParallelReduceSubscriber r4 = new io.reactivex.internal.operators.parallel.ParallelReduce$ParallelReduceSubscriber
            r5 = r8[r2]
            io.reactivex.functions.BiFunction<R, ? super T, R> r6 = r7.reducer
            r4.<init>(r5, r3, r6)
            r1[r2] = r4
            int r2 = r2 + 1
            goto Lb
