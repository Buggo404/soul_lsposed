...
public final class FlowableFlatMapMaybe<T, R> extends io.reactivex.internal.operators.flowable.AbstractFlowableWithUpstream<T, R> {
    ...
    static final class FlatMapMaybeSubscriber<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.FlowableSubscriber<T>, org.reactivestreams.Subscription {
        ...
        /* renamed from: s */
        org.reactivestreams.Subscription f256s;
        ...
        final class InnerObserver extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<R>, io.reactivex.disposables.Disposable {
            ...
            final /* synthetic */ io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe.FlatMapMaybeSubscriber this$0;

            InnerObserver(io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe.FlatMapMaybeSubscriber r1) {
                    r0 = this;
                    r0.this$0 = r1
                    r0.<init>()
                    return
            ...
            public void onComplete() {
                    r1 = this;
                    io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe$FlatMapMaybeSubscriber r0 = r1.this$0
                    r0.innerComplete(r1)
                    return
            }
        ...
        FlatMapMaybeSubscriber(org.reactivestreams.Subscriber<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> r2, boolean r3, int r4) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void cancel() {
                ...
                r0 = 1
                r1.cancelled = r0
                org.reactivestreams.Subscription r0 = r1.f256s
                r0.cancel()
        ...
        void drainLoop() {
            ...
            Lc8:
                ...
                if (r6 == r7) goto Ldd
                org.reactivestreams.Subscription r6 = r0.f256s
                r6.request(r10)
            Ldd:
                int r5 = -r5
        ...
        void innerComplete(io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe.FlatMapMaybeSubscriber<T, R>.InnerObserver r6) {
                r5 = this;
                ...
                r6 = 0
                r3 = 1
                boolean r4 = r5.compareAndSet(r6, r3)
                if (r4 == 0) goto L5b
                java.util.concurrent.atomic.AtomicInteger r4 = r5.active
                int r4 = r4.decrementAndGet()
                if (r4 != 0) goto L21
                r6 = r3
            L21:
                java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.queue.SpscLinkedArrayQueue<R>> r3 = r5.queue
            ...
            L47:
                ...
                if (r6 == r2) goto L50
                org.reactivestreams.Subscription r6 = r5.f256s
                r6.request(r0)
            L50:
        ...
        void innerError(io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe.FlatMapMaybeSubscriber<T, R>.InnerObserver r3, java.lang.Throwable r4) {
                r2 = this;
                ...
                if (r3 != 0) goto L1c
                org.reactivestreams.Subscription r3 = r2.f256s
                r3.cancel()
        ...
        void innerSuccess(io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe.FlatMapMaybeSubscriber<T, R>.InnerObserver r5, R r6) {
                r4 = this;
            ...
            L53:
                ...
                if (r5 == r6) goto L70
                org.reactivestreams.Subscription r5 = r4.f256s
                r5.request(r0)
                goto L70
            L67:
        ...
        public void onNext(T r3) {
                ...
                r0.getAndIncrement()
                io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver r0 = new io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver
                r0.<init>(r2)
            ...
            L28:
                ...
                org.reactivestreams.Subscription r0 = r2.f256s
                r0.cancel()
                r2.onError(r3)
                return
        }
    ...
    public FlowableFlatMapMaybe(io.reactivex.Flowable<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> r2, boolean r3, int r4) {
            r0 = this;
            r0.<init>(r1)
            r0.mapper = r2
            r0.delayErrors = r3
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super R> r6) {
            ...
            io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe$FlatMapMaybeSubscriber r1 = new io.reactivex.internal.operators.flowable.FlowableFlatMapMaybe$FlatMapMaybeSubscriber
