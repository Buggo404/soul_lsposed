...
public final class ObservableMergeWithSingle<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    ...
    static final class MergeWithObserver<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        static final class OtherObserver<T> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.SingleObserver<T> {
            ...
            OtherObserver(io.reactivex.internal.operators.observable.ObservableMergeWithSingle.MergeWithObserver<T> r1) {
                    r0 = this;
                    r0.<init>()
                    r0.parent = r1
                    return
            ...
            public void onError(java.lang.Throwable r2) {
                    r1 = this;
                    io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver<T> r0 = r1.parent
                    r0.otherError(r2)
                    return
            }
        ...
        MergeWithObserver(io.reactivex.Observer<? super T> r1) {
                ...
                io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver$OtherObserver r1 = new io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver$OtherObserver
                r1.<init>(r0)
                r0.otherObserver = r1
        ...
        public void dispose() {
                ...
                io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver$OtherObserver<T> r0 = r1.otherObserver
                io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
    ...
    public ObservableMergeWithSingle(io.reactivex.Observable<T> r1, io.reactivex.SingleSource<? extends T> r2) {
            r0 = this;
            r0.<init>(r1)
            r0.other = r2
            return
    ...
    protected void subscribeActual(io.reactivex.Observer<? super T> r2) {
            r1 = this;
            io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver r0 = new io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver
            r0.<init>(r2)
            r2.onSubscribe(r0)
            io.reactivex.ObservableSource<T> r2 = r1.source
            r2.subscribe(r0)
            io.reactivex.SingleSource<? extends T> r2 = r1.other
            io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver$OtherObserver<T> r0 = r0.otherObserver
            r2.subscribe(r0)
            return
    }
}
