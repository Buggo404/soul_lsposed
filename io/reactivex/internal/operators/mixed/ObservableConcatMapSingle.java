...
public final class ObservableConcatMapSingle<T, R> extends io.reactivex.Observable<R> {
    ...
    static final class ConcatMapSingleMainObserver<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        final io.reactivex.internal.operators.mixed.ObservableConcatMapSingle.ConcatMapSingleMainObserver.ConcatMapSingleObserver<R> inner;
        R item;
        final io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> mapper;
        ...
        static final class ConcatMapSingleObserver<R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.SingleObserver<R> {
            ...
            ConcatMapSingleObserver(io.reactivex.internal.operators.mixed.ObservableConcatMapSingle.ConcatMapSingleMainObserver<?, R> r1) {
                    r0 = this;
                    r0.<init>()
                    r0.parent = r1
                    return
            ...
            public void onError(java.lang.Throwable r2) {
                    r1 = this;
                    io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver<?, R> r0 = r1.parent
                    r0.innerError(r2)
                    return
            }
        ...
        ConcatMapSingleMainObserver(io.reactivex.Observer<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2, int r3, io.reactivex.internal.util.ErrorMode r4) {
                r0 = this;
                r0.<init>()
                r0.downstream = r1
                r0.mapper = r2
                ...
                r1.<init>()
                r0.errors = r1
                io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver$ConcatMapSingleObserver r1 = new io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver$ConcatMapSingleObserver
                r1.<init>(r0)
                r0.inner = r1
        ...
        public void dispose() {
                ...
                r0.dispose()
                io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver$ConcatMapSingleObserver<R> r0 = r1.inner
                r0.dispose()
        ...
        public void onError(java.lang.Throwable r2) {
                ...
                if (r2 != r0) goto L13
                io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver$ConcatMapSingleObserver<R> r2 = r1.inner
                r2.dispose()
            L13:
                r2 = 1
                r1.done = r2
    ...
    public ObservableConcatMapSingle(io.reactivex.Observable<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2, io.reactivex.internal.util.ErrorMode r3, int r4) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(io.reactivex.Observer<? super R> r6) {
            ...
            io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r1 = r5.mapper
            boolean r0 = io.reactivex.internal.operators.mixed.ScalarXMapZHelper.tryAsSingle(r0, r1, r6)
            if (r0 != 0) goto L1a
            io.reactivex.Observable<T> r0 = r5.source
            io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver r1 = new io.reactivex.internal.operators.mixed.ObservableConcatMapSingle$ConcatMapSingleMainObserver
