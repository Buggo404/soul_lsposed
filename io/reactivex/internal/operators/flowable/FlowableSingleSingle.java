...
public final class FlowableSingleSingle<T> extends io.reactivex.Single<T> implements io.reactivex.internal.fuseable.FuseToFlowable<T> {
    ...
    static final class SingleElementSubscriber<T> implements io.reactivex.FlowableSubscriber<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        org.reactivestreams.Subscription f298s;
        T value;

        SingleElementSubscriber(io.reactivex.SingleObserver<? super T> r1, T r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.defaultValue = r2
        ...
        public void dispose() {
                r1 = this;
                org.reactivestreams.Subscription r0 = r1.f298s
                r0.cancel()
        ...
        public boolean isDisposed() {
                r2 = this;
                org.reactivestreams.Subscription r0 = r2.f298s
        ...
        public void onNext(T r3) {
            ...
            L5:
                ...
                r3 = 1
                r2.done = r3
                org.reactivestreams.Subscription r3 = r2.f298s
                r3.cancel()
    ...
    public FlowableSingleSingle(io.reactivex.Flowable<T> r1, T r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.defaultValue = r2
    ...
    protected void subscribeActual(io.reactivex.SingleObserver<? super T> r4) {
            ...
            io.reactivex.internal.operators.flowable.FlowableSingleSingle$SingleElementSubscriber r1 = new io.reactivex.internal.operators.flowable.FlowableSingleSingle$SingleElementSubscriber
