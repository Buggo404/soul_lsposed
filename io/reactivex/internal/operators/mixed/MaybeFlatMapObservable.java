...
public final class MaybeFlatMapObservable<T, R> extends io.reactivex.Observable<R> {
    ...
    public MaybeFlatMapObservable(io.reactivex.MaybeSource<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.ObservableSource<? extends R>> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(io.reactivex.Observer<? super R> r3) {
            r2 = this;
            io.reactivex.internal.operators.mixed.MaybeFlatMapObservable$FlatMapObserver r0 = new io.reactivex.internal.operators.mixed.MaybeFlatMapObservable$FlatMapObserver
