...
public final class FlowableFlatMapCompletableCompletable<T> extends io.reactivex.Completable implements io.reactivex.internal.fuseable.FuseToFlowable<T> {
    ...
    static final class FlatMapCompletableMainSubscriber<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.FlowableSubscriber<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        org.reactivestreams.Subscription f255s;
        ...
        final class InnerObserver extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.CompletableObserver, io.reactivex.disposables.Disposable {
            ...
            final /* synthetic */ io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable.FlatMapCompletableMainSubscriber this$0;

            InnerObserver(io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable.FlatMapCompletableMainSubscriber r1) {
                    r0 = this;
                    r0.this$0 = r1
                    r0.<init>()
                    return
            ...
            public void onComplete() {
                    r1 = this;
                    io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable$FlatMapCompletableMainSubscriber r0 = r1.this$0
                    r0.innerComplete(r1)
                    return
            }
        ...
        FlatMapCompletableMainSubscriber(io.reactivex.CompletableObserver r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2, boolean r3, int r4) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void dispose() {
                ...
                r0 = 1
                r1.disposed = r0
                org.reactivestreams.Subscription r0 = r1.f255s
                r0.cancel()
        ...
        void innerComplete(io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable.FlatMapCompletableMainSubscriber<T>.InnerObserver r2) {
                r1 = this;
                io.reactivex.disposables.CompositeDisposable r0 = r1.set
                r0.delete(r2)
                r1.onComplete()
        ...
        void innerError(io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable.FlatMapCompletableMainSubscriber<T>.InnerObserver r2, java.lang.Throwable r3) {
                r1 = this;
                io.reactivex.disposables.CompositeDisposable r0 = r1.set
                r0.delete(r2)
                r1.onError(r3)
        ...
        public void onComplete() {
            ...
            L1a:
                ...
                if (r0 == r1) goto L28
                org.reactivestreams.Subscription r0 = r3.f255s
                r1 = 1
                r0.request(r1)
            L28:
                return
        ...
        public void onError(java.lang.Throwable r3) {
            ...
            L1e:
                ...
                if (r3 == r0) goto L46
                org.reactivestreams.Subscription r3 = r2.f255s
                r0 = 1
                r3.request(r0)
                goto L46
            L2d:
        ...
        public void onNext(T r3) {
                ...
                r2.getAndIncrement()
                io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable$FlatMapCompletableMainSubscriber$InnerObserver r0 = new io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable$FlatMapCompletableMainSubscriber$InnerObserver
                r0.<init>(r2)
            ...
            L26:
                ...
                org.reactivestreams.Subscription r0 = r2.f255s
                r0.cancel()
                r2.onError(r3)
                return
        }
    ...
    public FlowableFlatMapCompletableCompletable(io.reactivex.Flowable<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2, boolean r3, int r4) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    public io.reactivex.Flowable<T> fuseToFlowable() {
            r5 = this;
            io.reactivex.internal.operators.flowable.FlowableFlatMapCompletable r0 = new io.reactivex.internal.operators.flowable.FlowableFlatMapCompletable
    ...
    protected void subscribeActual(io.reactivex.CompletableObserver r6) {
            ...
            io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable$FlatMapCompletableMainSubscriber r1 = new io.reactivex.internal.operators.flowable.FlowableFlatMapCompletableCompletable$FlatMapCompletableMainSubscriber
            io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2 = r5.mapper
            boolean r3 = r5.delayErrors
            int r4 = r5.maxConcurrency
            r1.<init>(r6, r2, r3, r4)
