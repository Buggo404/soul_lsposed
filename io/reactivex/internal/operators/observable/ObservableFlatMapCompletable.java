...
public final class ObservableFlatMapCompletable<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    ...
    static final class FlatMapCompletableMainObserver<T> extends io.reactivex.internal.observers.BasicIntQueueDisposable<T> implements io.reactivex.Observer<T> {
        ...
        /* renamed from: d */
        io.reactivex.disposables.Disposable f406d;
        final boolean delayErrors;
        ...
        final class InnerObserver extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.CompletableObserver, io.reactivex.disposables.Disposable {
            ...
            final /* synthetic */ io.reactivex.internal.operators.observable.ObservableFlatMapCompletable.FlatMapCompletableMainObserver this$0;

            InnerObserver(io.reactivex.internal.operators.observable.ObservableFlatMapCompletable.FlatMapCompletableMainObserver r1) {
                    r0 = this;
                    r0.this$0 = r1
                    r0.<init>()
                    return
            ...
            public void onComplete() {
                    r1 = this;
                    io.reactivex.internal.operators.observable.ObservableFlatMapCompletable$FlatMapCompletableMainObserver r0 = r1.this$0
                    r0.innerComplete(r1)
                    return
            }
        ...
        FlatMapCompletableMainObserver(io.reactivex.Observer<? super T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2, boolean r3) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void dispose() {
                ...
                r0 = 1
                r1.disposed = r0
                io.reactivex.disposables.Disposable r0 = r1.f406d
                r0.dispose()
        ...
        void innerComplete(io.reactivex.internal.operators.observable.ObservableFlatMapCompletable.FlatMapCompletableMainObserver<T>.InnerObserver r2) {
                r1 = this;
                io.reactivex.disposables.CompositeDisposable r0 = r1.set
                r0.delete(r2)
                r1.onComplete()
        ...
        void innerError(io.reactivex.internal.operators.observable.ObservableFlatMapCompletable.FlatMapCompletableMainObserver<T>.InnerObserver r2, java.lang.Throwable r3) {
                r1 = this;
                io.reactivex.disposables.CompositeDisposable r0 = r1.set
                r0.delete(r2)
                r1.onError(r3)
        ...
        public void onNext(T r3) {
                ...
                r2.getAndIncrement()
                io.reactivex.internal.operators.observable.ObservableFlatMapCompletable$FlatMapCompletableMainObserver$InnerObserver r0 = new io.reactivex.internal.operators.observable.ObservableFlatMapCompletable$FlatMapCompletableMainObserver$InnerObserver
                r0.<init>(r2)
            ...
            L26:
                ...
                io.reactivex.disposables.Disposable r0 = r2.f406d
                r0.dispose()
                r2.onError(r3)
                return
        }
    ...
    public ObservableFlatMapCompletable(io.reactivex.ObservableSource<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2, boolean r3) {
            r0 = this;
            r0.<init>(r1)
            r0.mapper = r2
            r0.delayErrors = r3
    ...
    protected void subscribeActual(io.reactivex.Observer<? super T> r5) {
            ...
            io.reactivex.internal.operators.observable.ObservableFlatMapCompletable$FlatMapCompletableMainObserver r1 = new io.reactivex.internal.operators.observable.ObservableFlatMapCompletable$FlatMapCompletableMainObserver
