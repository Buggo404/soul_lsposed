...
public final class ObservableConcatWithMaybe<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    ...
    static final class ConcatWithObserver<T> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.Observer<T>, io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable {
        ...
        ConcatWithObserver(io.reactivex.Observer<? super T> r1, io.reactivex.MaybeSource<? extends T> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.other = r2
        ...
        public void onComplete() {
            ...
            La:
                ...
                io.reactivex.MaybeSource<? extends T> r1 = r2.other
                r2.other = r0
                r1.subscribe(r2)
            L18:
                return
    ...
    public ObservableConcatWithMaybe(io.reactivex.Observable<T> r1, io.reactivex.MaybeSource<? extends T> r2) {
            r0 = this;
            r0.<init>(r1)
            r0.other = r2
            return
    ...
    protected void subscribeActual(io.reactivex.Observer<? super T> r4) {
            ...
            io.reactivex.internal.operators.observable.ObservableConcatWithMaybe$ConcatWithObserver r1 = new io.reactivex.internal.operators.observable.ObservableConcatWithMaybe$ConcatWithObserver
