...
public final class MaybeConcatArrayDelayError<T> extends io.reactivex.Flowable<T> {
    ...
    static final class ConcatMaybeObserver<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.MaybeObserver<T>, org.reactivestreams.Subscription {
        ...
        void drain() {
            ...
            L41:
                ...
                int r5 = r4.length
                if (r3 != r5) goto L68
                io.reactivex.internal.util.AtomicThrowable r0 = r11.errors
    ...
    public MaybeConcatArrayDelayError(io.reactivex.MaybeSource<? extends T>[] r1) {
            r0 = this;
            r0.<init>()
            r0.sources = r1
            return
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super T> r3) {
            r2 = this;
            io.reactivex.internal.operators.maybe.MaybeConcatArrayDelayError$ConcatMaybeObserver r0 = new io.reactivex.internal.operators.maybe.MaybeConcatArrayDelayError$ConcatMaybeObserver
