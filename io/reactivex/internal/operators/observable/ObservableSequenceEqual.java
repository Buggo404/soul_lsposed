...
public final class ObservableSequenceEqual<T> extends io.reactivex.Observable<java.lang.Boolean> {
    ...
    static final class EqualCoordinator<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.disposables.Disposable {
        ...
        EqualCoordinator(io.reactivex.Observer<? super java.lang.Boolean> r1, int r2, io.reactivex.ObservableSource<? extends T> r3, io.reactivex.ObservableSource<? extends T> r4, io.reactivex.functions.BiPredicate<? super T, ? super T> r5) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.first = r3
                ...
                r0.comparer = r5
                r1 = 2
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver[] r3 = new io.reactivex.internal.operators.observable.ObservableSequenceEqual.EqualObserver[r1]
                r0.observers = r3
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver r4 = new io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver
                r5 = 0
                r4.<init>(r0, r5, r2)
                r3[r5] = r4
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver r4 = new io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver
        ...
        public void dispose() {
                ...
                if (r1 != 0) goto L23
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver<T>[] r1 = r3.observers
                r2 = 0
                r2 = r1[r2]
        ...
        void drain() {
                ...
                return
            L7:
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver<T>[] r0 = r12.observers
                r1 = 0
                r2 = r0[r1]
            ...
            L1f:
                ...
                if (r8 == 0) goto L30
                r12.cancel(r3, r5)
                io.reactivex.Observer<? super java.lang.Boolean> r0 = r12.actual
                r0.onError(r8)
                return
            L30:
                boolean r8 = r0.done
            ...
            L92:
                if (r9 != 0) goto Lc5
                if (r11 != 0) goto Lc5
                io.reactivex.functions.BiPredicate<? super T, ? super T> r7 = r12.comparer     // Catch: java.lang.Throwable -> Lb8
                T r8 = r12.f440v1     // Catch: java.lang.Throwable -> Lb8
                boolean r7 = r7.test(r8, r10)     // Catch: java.lang.Throwable -> Lb8
                if (r7 != 0) goto Lb2
                r12.cancel(r3, r5)
                io.reactivex.Observer<? super java.lang.Boolean> r0 = r12.actual
                java.lang.Boolean r1 = java.lang.Boolean.valueOf(r1)
            ...
            Lb8:
                ...
                r12.cancel(r3, r5)
                io.reactivex.Observer<? super java.lang.Boolean> r1 = r12.actual
                r1.onError(r0)
                return
            Lc5:
                if (r9 != 0) goto Lc9
        ...
        void subscribe() {
                r3 = this;
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualObserver<T>[] r0 = r3.observers
    ...
    static final class EqualObserver<T> implements io.reactivex.Observer<T> {
        ...
        final int index;
        final io.reactivex.internal.operators.observable.ObservableSequenceEqual.EqualCoordinator<T> parent;
        final io.reactivex.internal.queue.SpscLinkedArrayQueue<T> queue;

        EqualObserver(io.reactivex.internal.operators.observable.ObservableSequenceEqual.EqualCoordinator<T> r1, int r2, int r3) {
                r0 = this;
                r0.<init>()
                r0.parent = r1
                r0.index = r2
        ...
        public void onComplete() {
                ...
                r0 = 1
                r1.done = r0
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator<T> r0 = r1.parent
                r0.drain()
                return
        }
        ...
        public void onError(java.lang.Throwable r1) {
                ...
                r1 = 1
                r0.done = r1
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator<T> r1 = r0.parent
                r1.drain()
                return
        }
        ...
        public void onNext(T r2) {
                ...
                r0.offer(r2)
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator<T> r2 = r1.parent
                r2.drain()
                return
        }
        ...
        public void onSubscribe(io.reactivex.disposables.Disposable r3) {
                r2 = this;
                io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator<T> r0 = r2.parent
                int r1 = r2.index
    ...
    public ObservableSequenceEqual(io.reactivex.ObservableSource<? extends T> r1, io.reactivex.ObservableSource<? extends T> r2, io.reactivex.functions.BiPredicate<? super T, ? super T> r3, int r4) {
            r0 = this;
            r0.<init>()
            r0.first = r1
            r0.second = r2
    ...
    public void subscribeActual(io.reactivex.Observer<? super java.lang.Boolean> r8) {
            r7 = this;
            io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator r6 = new io.reactivex.internal.operators.observable.ObservableSequenceEqual$EqualCoordinator
