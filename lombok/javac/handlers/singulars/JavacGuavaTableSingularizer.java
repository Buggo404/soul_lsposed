...
/* loaded from: com.usidqw.qwerklj.apk:lombok/javac/handlers/singulars/JavacGuavaTableSingularizer.SCL.lombok */
public class JavacGuavaTableSingularizer extends lombok.javac.handlers.singulars.JavacGuavaSingularizer {
    ...
    static {
            ...
            lombok.javac.handlers.singulars.JavacGuavaTableSingularizer.SUFFIXES = r0
            ...
            lombok.javac.handlers.singulars.JavacGuavaTableSingularizer.SUPPORTED_TYPES = r0
            return
    }

    public JavacGuavaTableSingularizer() {
            r2 = this;
            r0 = r2
            r0.<init>()
            return
    ...
    public lombok.core.LombokImmutableList<java.lang.String> getSupportedTypes() {
            r2 = this;
            lombok.core.LombokImmutableList<java.lang.String> r0 = lombok.javac.handlers.singulars.JavacGuavaTableSingularizer.SUPPORTED_TYPES
            return r0
    }
    ...
    protected lombok.core.LombokImmutableList<java.lang.String> getArgumentSuffixes() {
            r2 = this;
            lombok.core.LombokImmutableList<java.lang.String> r0 = lombok.javac.handlers.singulars.JavacGuavaTableSingularizer.SUFFIXES
            return r0
    }
