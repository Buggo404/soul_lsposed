...
/* loaded from: com.usidqw.qwerklj.apk:lombok/eclipse/handlers/singulars/EclipseGuavaMapSingularizer.SCL.lombok */
public class EclipseGuavaMapSingularizer extends lombok.eclipse.handlers.singulars.EclipseGuavaSingularizer {
    ...
    static {
            ...
            lombok.eclipse.handlers.singulars.EclipseGuavaMapSingularizer.SUFFIXES = r0
            ...
            lombok.eclipse.handlers.singulars.EclipseGuavaMapSingularizer.SUPPORTED_TYPES = r0
            return
    }

    public EclipseGuavaMapSingularizer() {
            r2 = this;
            r0 = r2
            r0.<init>()
            return
    ...
    public lombok.core.LombokImmutableList<java.lang.String> getSupportedTypes() {
            r2 = this;
            lombok.core.LombokImmutableList<java.lang.String> r0 = lombok.eclipse.handlers.singulars.EclipseGuavaMapSingularizer.SUPPORTED_TYPES
            return r0
    }
    ...
    protected lombok.core.LombokImmutableList<java.lang.String> getArgumentSuffixes() {
            r2 = this;
            lombok.core.LombokImmutableList<java.lang.String> r0 = lombok.eclipse.handlers.singulars.EclipseGuavaMapSingularizer.SUFFIXES
            return r0
    }
