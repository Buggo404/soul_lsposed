...
public final class ObservableAllSingle<T> extends io.reactivex.Single<java.lang.Boolean> implements io.reactivex.internal.fuseable.FuseToObservable<java.lang.Boolean> {
    ...
    static final class AllObserver<T> implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        io.reactivex.disposables.Disposable f369s;

        AllObserver(io.reactivex.SingleObserver<? super java.lang.Boolean> r1, io.reactivex.functions.Predicate<? super T> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.predicate = r2
        ...
        public void dispose() {
                r1 = this;
                io.reactivex.disposables.Disposable r0 = r1.f369s
                r0.dispose()
                return
        }
        ...
        public void onNext(T r2) {
                ...
                return
            L5:
                io.reactivex.functions.Predicate<? super T> r0 = r1.predicate     // Catch: java.lang.Throwable -> L20
                boolean r2 = r0.test(r2)     // Catch: java.lang.Throwable -> L20
                if (r2 != 0) goto L1f
                r2 = 1
                r1.done = r2
                io.reactivex.disposables.Disposable r2 = r1.f369s
                r2.dispose()
    ...
    public ObservableAllSingle(io.reactivex.ObservableSource<T> r1, io.reactivex.functions.Predicate<? super T> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.predicate = r2
    ...
    public io.reactivex.Observable<java.lang.Boolean> fuseToObservable() {
            r3 = this;
            io.reactivex.internal.operators.observable.ObservableAll r0 = new io.reactivex.internal.operators.observable.ObservableAll
    ...
    protected void subscribeActual(io.reactivex.SingleObserver<? super java.lang.Boolean> r4) {
            ...
            io.reactivex.internal.operators.observable.ObservableAllSingle$AllObserver r1 = new io.reactivex.internal.operators.observable.ObservableAllSingle$AllObserver
            io.reactivex.functions.Predicate<? super T> r2 = r3.predicate
            r1.<init>(r4, r2)
            r0.subscribe(r1)
            return
