...
public abstract class ProgressLoadingCallBack<T> extends com.xuexiang.xhttp2.callback.CallBack<T> implements com.xuexiang.xhttp2.subsciber.impl.OnProgressCancelListener {
    ...
    public ProgressLoadingCallBack(com.xuexiang.xhttp2.subsciber.impl.IProgressLoader r2) {
            r1 = this;
            r1.<init>()
            r0 = 1
    ...
    public ProgressLoadingCallBack(com.xuexiang.xhttp2.subsciber.impl.IProgressLoader r1, boolean r2, boolean r3) {
            r0 = this;
            r0.<init>()
    ...
    public void onCancelProgress() {
            r1 = this;
            io.reactivex.disposables.Disposable r0 = r1.mDisposable
            if (r0 == 0) goto Lf
    ...
    public void subscription(io.reactivex.disposables.Disposable r1) {
            r0 = this;
            r0.mDisposable = r1
            return
    }
