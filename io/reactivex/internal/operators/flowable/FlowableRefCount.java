...
public final class FlowableRefCount<T> extends io.reactivex.Flowable<T> {
    ...
    static final class RefConnection extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements java.lang.Runnable, io.reactivex.functions.Consumer<io.reactivex.disposables.Disposable> {
        ...
        RefConnection(io.reactivex.internal.operators.flowable.FlowableRefCount<?> r1) {
                r0 = this;
                r0.<init>()
                r0.parent = r1
                return
        ...
        public void run() {
                r1 = this;
                io.reactivex.internal.operators.flowable.FlowableRefCount<?> r0 = r1.parent
                r0.timeout(r1)
                return
        }
    }
    ...
    static final class RefCountSubscriber<T> extends java.util.concurrent.atomic.AtomicBoolean implements io.reactivex.FlowableSubscriber<T>, org.reactivestreams.Subscription {
        ...
        RefCountSubscriber(org.reactivestreams.Subscriber<? super T> r1, io.reactivex.internal.operators.flowable.FlowableRefCount<T> r2, io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r3) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.parent = r2
        ...
        public void cancel() {
                ...
                if (r0 == 0) goto L14
                io.reactivex.internal.operators.flowable.FlowableRefCount<T> r0 = r2.parent
                io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r1 = r2.connection
                r0.cancel(r1)
            L14:
                return
        }
    ...
    public FlowableRefCount(io.reactivex.flowables.ConnectableFlowable<T> r8) {
            r7 = this;
            r2 = 1
            r3 = 0
    ...
    public FlowableRefCount(io.reactivex.flowables.ConnectableFlowable<T> r1, int r2, long r3, java.util.concurrent.TimeUnit r5, io.reactivex.Scheduler r6) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.f282n = r2
    ...
    void cancel(io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r6) {
            r5 = this;
            monitor-enter(r5)
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r0 = r5.connection     // Catch: java.lang.Throwable -> L3c
            if (r0 != 0) goto L7
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super T> r6) {
            r5 = this;
            monitor-enter(r5)
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r0 = r5.connection     // Catch: java.lang.Throwable -> L45
            if (r0 != 0) goto Lc
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r0 = new io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection     // Catch: java.lang.Throwable -> L45
        ...
        L1d:
            ...
            if (r3 != 0) goto L31
            int r3 = r5.f282n     // Catch: java.lang.Throwable -> L45
        ...
        L32:
            ...
            io.reactivex.flowables.ConnectableFlowable<T> r2 = r5.source
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefCountSubscriber r3 = new io.reactivex.internal.operators.flowable.FlowableRefCount$RefCountSubscriber
            r3.<init>(r6, r5, r0)
            r2.subscribe(r3)
            if (r1 == 0) goto L44
            io.reactivex.flowables.ConnectableFlowable<T> r6 = r5.source
            r6.connect(r0)
        L44:
            return
        L45:
    ...
    void terminated(io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r2) {
            r1 = this;
            monitor-enter(r1)
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L1e
            if (r0 == 0) goto L1c
            r0 = 0
        ...
        L11:
            io.reactivex.flowables.ConnectableFlowable<T> r2 = r1.source     // Catch: java.lang.Throwable -> L1e
    ...
    void timeout(io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r5) {
            r4 = this;
            monitor-enter(r4)
            ...
            int r0 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r0 != 0) goto L1e
            io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection r0 = r4.connection     // Catch: java.lang.Throwable -> L20
            if (r5 != r0) goto L1e
            r0 = 0
            ...
            io.reactivex.flowables.ConnectableFlowable<T> r5 = r4.source     // Catch: java.lang.Throwable -> L20
