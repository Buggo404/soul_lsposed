...
public final class FlowableMergeWithSingle<T> extends io.reactivex.internal.operators.flowable.AbstractFlowableWithUpstream<T, T> {
    ...
    static final class MergeWithObserver<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.FlowableSubscriber<T>, org.reactivestreams.Subscription {
        ...
        static final class OtherObserver<T> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.SingleObserver<T> {
            ...
            OtherObserver(io.reactivex.internal.operators.flowable.FlowableMergeWithSingle.MergeWithObserver<T> r1) {
                    r0 = this;
                    r0.<init>()
                    r0.parent = r1
                    return
            ...
            public void onError(java.lang.Throwable r2) {
                    r1 = this;
                    io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver<T> r0 = r1.parent
                    r0.otherError(r2)
                    return
            }
        ...
        MergeWithObserver(org.reactivestreams.Subscriber<? super T> r2) {
                ...
                io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver$OtherObserver r2 = new io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver$OtherObserver
                r2.<init>(r1)
                r1.otherObserver = r2
        ...
        public void cancel() {
                ...
                io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver$OtherObserver<T> r0 = r1.otherObserver
    ...
    public FlowableMergeWithSingle(io.reactivex.Flowable<T> r1, io.reactivex.SingleSource<? extends T> r2) {
            r0 = this;
            r0.<init>(r1)
            r0.other = r2
            return
    ...
    protected void subscribeActual(org.reactivestreams.Subscriber<? super T> r2) {
            r1 = this;
            io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver r0 = new io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver
            r0.<init>(r2)
            r2.onSubscribe(r0)
            io.reactivex.Flowable<T> r2 = r1.source
            r2.subscribe(r0)
            io.reactivex.SingleSource<? extends T> r2 = r1.other
            io.reactivex.internal.operators.flowable.FlowableMergeWithSingle$MergeWithObserver$OtherObserver<T> r0 = r0.otherObserver
            r2.subscribe(r0)
            return
    }
}
