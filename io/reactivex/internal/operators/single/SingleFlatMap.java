...
public final class SingleFlatMap<T, R> extends io.reactivex.Single<R> {
    ...
    static final class SingleFlatMapCallback<T, R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.SingleObserver<T>, io.reactivex.disposables.Disposable {
        ...
        static final class FlatMapSingleObserver<R> implements io.reactivex.SingleObserver<R> {
            ...
            FlatMapSingleObserver(java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r1, io.reactivex.SingleObserver<? super R> r2) {
                    r0 = this;
                    r0.<init>()
                    r0.parent = r1
                    r0.actual = r2
        ...
        SingleFlatMapCallback(io.reactivex.SingleObserver<? super R> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.mapper = r2
        ...
        public void onSubscribe(io.reactivex.disposables.Disposable r1) {
                ...
                if (r1 == 0) goto Lb
                io.reactivex.SingleObserver<? super R> r1 = r0.actual
                r1.onSubscribe(r0)
            Lb:
                return
        }
        ...
        public void onSuccess(T r3) {
                r2 = this;
                io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r0 = r2.mapper     // Catch: java.lang.Throwable -> L1f
                java.lang.Object r3 = r0.apply(r3)     // Catch: java.lang.Throwable -> L1f
                java.lang.String r0 = "The single returned by the mapper is null"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r3, r0)     // Catch: java.lang.Throwable -> L1f
                io.reactivex.SingleSource r3 = (io.reactivex.SingleSource) r3     // Catch: java.lang.Throwable -> L1f
                boolean r0 = r2.isDisposed()
                if (r0 != 0) goto L1e
                io.reactivex.internal.operators.single.SingleFlatMap$SingleFlatMapCallback$FlatMapSingleObserver r0 = new io.reactivex.internal.operators.single.SingleFlatMap$SingleFlatMapCallback$FlatMapSingleObserver
    ...
    public SingleFlatMap(io.reactivex.SingleSource<? extends T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2) {
            r0 = this;
            r0.<init>()
            r0.mapper = r2
            r0.source = r1
    ...
    protected void subscribeActual(io.reactivex.SingleObserver<? super R> r4) {
            ...
            io.reactivex.internal.operators.single.SingleFlatMap$SingleFlatMapCallback r1 = new io.reactivex.internal.operators.single.SingleFlatMap$SingleFlatMapCallback
            io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r2 = r3.mapper
            r1.<init>(r4, r2)
            r0.subscribe(r1)
            return
    }
