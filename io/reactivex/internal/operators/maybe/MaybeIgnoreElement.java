...
public final class MaybeIgnoreElement<T> extends io.reactivex.internal.operators.maybe.AbstractMaybeWithUpstream<T, T> {
    ...
    static final class IgnoreMaybeObserver<T> implements io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: d */
        io.reactivex.disposables.Disposable f354d;

        IgnoreMaybeObserver(io.reactivex.MaybeObserver<? super T> r1) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                return
        ...
        public void dispose() {
                r1 = this;
                io.reactivex.disposables.Disposable r0 = r1.f354d
                r0.dispose()
    ...
    public MaybeIgnoreElement(io.reactivex.MaybeSource<T> r1) {
            r0 = this;
            r0.<init>(r1)
            return
    }
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super T> r3) {
            ...
            io.reactivex.internal.operators.maybe.MaybeIgnoreElement$IgnoreMaybeObserver r1 = new io.reactivex.internal.operators.maybe.MaybeIgnoreElement$IgnoreMaybeObserver
            r1.<init>(r3)
            r0.subscribe(r1)
            return
    }
