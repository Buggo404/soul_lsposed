...
public final class ObservableReduceWithSingle<T, R> extends io.reactivex.Single<R> {
    ...
    public ObservableReduceWithSingle(io.reactivex.ObservableSource<T> r1, java.util.concurrent.Callable<R> r2, io.reactivex.functions.BiFunction<R, ? super T, R> r3) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.seedSupplier = r2
    ...
    protected void subscribeActual(io.reactivex.SingleObserver<? super R> r5) {
            ...
            io.reactivex.internal.operators.observable.ObservableReduceSeedSingle$ReduceSeedObserver r2 = new io.reactivex.internal.operators.observable.ObservableReduceSeedSingle$ReduceSeedObserver
