...
public final class MaybeZipArray<T, R> extends io.reactivex.Maybe<R> {
    ...
    final class SingletonArrayFunc implements io.reactivex.functions.Function<T, R> {
        final /* synthetic */ io.reactivex.internal.operators.maybe.MaybeZipArray this$0;

        SingletonArrayFunc(io.reactivex.internal.operators.maybe.MaybeZipArray r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
                return
        ...
        public R apply(T r4) throws java.lang.Exception {
                r3 = this;
                io.reactivex.internal.operators.maybe.MaybeZipArray r0 = r3.this$0
    ...
    static final class ZipCoordinator<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.disposables.Disposable {
        ...
        ZipCoordinator(io.reactivex.MaybeObserver<? super R> r2, int r3, io.reactivex.functions.Function<? super java.lang.Object[], ? extends R> r4) {
                r1 = this;
                r1.<init>(r3)
                r1.actual = r2
                r1.zipper = r4
                io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver[] r2 = new io.reactivex.internal.operators.maybe.MaybeZipArray.ZipMaybeObserver[r3]
                r4 = 0
            La:
                if (r4 >= r3) goto L16
                io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver r0 = new io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver
                r0.<init>(r1, r4)
                r2[r4] = r0
                int r4 = r4 + 1
                goto La
        ...
        public void dispose() {
                ...
                if (r1 <= 0) goto L14
                io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver<T>[] r1 = r4.observers
                int r2 = r1.length
            La:
                if (r0 >= r2) goto L14
                r3 = r1[r0]
        ...
        void disposeExcept(int r5) {
                r4 = this;
                io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver<T>[] r0 = r4.observers
                int r1 = r0.length
                r2 = 0
            L4:
                if (r2 >= r5) goto Le
        ...
        void innerError(java.lang.Throwable r2, int r3) {
                ...
                if (r0 <= 0) goto L10
                r1.disposeExcept(r3)
                io.reactivex.MaybeObserver<? super R> r3 = r1.actual
                r3.onError(r2)
                goto L13
            L10:
    ...
    static final class ZipMaybeObserver<T> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<T> {
        ...
        ZipMaybeObserver(io.reactivex.internal.operators.maybe.MaybeZipArray.ZipCoordinator<T, ?> r1, int r2) {
                r0 = this;
                r0.<init>()
                r0.parent = r1
                r0.index = r2
        ...
        public void onComplete() {
                r2 = this;
                io.reactivex.internal.operators.maybe.MaybeZipArray$ZipCoordinator<T, ?> r0 = r2.parent
                int r1 = r2.index
                r0.innerComplete(r1)
                return
        }
    ...
    public MaybeZipArray(io.reactivex.MaybeSource<? extends T>[] r1, io.reactivex.functions.Function<? super java.lang.Object[], ? extends R> r2) {
            r0 = this;
            r0.<init>()
            r0.sources = r1
            r0.zipper = r2
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super R> r6) {
            r5 = this;
            io.reactivex.MaybeSource<? extends T>[] r0 = r5.sources
            int r1 = r0.length
            r2 = 1
            r3 = 0
            if (r1 != r2) goto L17
            ...
            io.reactivex.internal.operators.maybe.MaybeZipArray$SingletonArrayFunc r2 = new io.reactivex.internal.operators.maybe.MaybeZipArray$SingletonArrayFunc
            r2.<init>(r5)
            r1.<init>(r6, r2)
            r0.subscribe(r1)
            return
        L17:
            io.reactivex.internal.operators.maybe.MaybeZipArray$ZipCoordinator r2 = new io.reactivex.internal.operators.maybe.MaybeZipArray$ZipCoordinator
        ...
        L2a:
            ...
            return
        L39:
            io.reactivex.internal.operators.maybe.MaybeZipArray$ZipMaybeObserver<T>[] r4 = r2.observers
            r4 = r4[r3]
            r6.subscribe(r4)
            int r3 = r3 + 1
            goto L21
