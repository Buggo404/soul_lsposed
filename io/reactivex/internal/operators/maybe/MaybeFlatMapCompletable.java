...
public final class MaybeFlatMapCompletable<T> extends io.reactivex.Completable {
    ...
    public MaybeFlatMapCompletable(io.reactivex.MaybeSource<T> r1, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.mapper = r2
    ...
    protected void subscribeActual(io.reactivex.CompletableObserver r3) {
            r2 = this;
            io.reactivex.internal.operators.maybe.MaybeFlatMapCompletable$FlatMapCompletableObserver r0 = new io.reactivex.internal.operators.maybe.MaybeFlatMapCompletable$FlatMapCompletableObserver
