...
public final class MaybeCallbackObserver<T> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable, io.reactivex.observers.LambdaConsumerIntrospection {
    ...
    public MaybeCallbackObserver(io.reactivex.functions.Consumer<? super T> r1, io.reactivex.functions.Consumer<? super java.lang.Throwable> r2, io.reactivex.functions.Action r3) {
            r0 = this;
            r0.<init>()
            r0.onSuccess = r1
            r0.onError = r2
    ...
    public void onComplete() {
            ...
            r1.lazySet(r0)
            io.reactivex.functions.Action r0 = r1.onComplete     // Catch: java.lang.Throwable -> Lb
