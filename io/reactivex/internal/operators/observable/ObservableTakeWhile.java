...
public final class ObservableTakeWhile<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    ...
    static final class TakeWhileObserver<T> implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        io.reactivex.disposables.Disposable f459s;

        TakeWhileObserver(io.reactivex.Observer<? super T> r1, io.reactivex.functions.Predicate<? super T> r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.predicate = r2
        ...
        public void dispose() {
                r1 = this;
                io.reactivex.disposables.Disposable r0 = r1.f459s
                r0.dispose()
                return
        }
        ...
        public void onNext(T r2) {
            ...
            L5:
                ...
                r2 = 1
                r1.done = r2
                io.reactivex.disposables.Disposable r2 = r1.f459s
                r2.dispose()
    ...
    public ObservableTakeWhile(io.reactivex.ObservableSource<T> r1, io.reactivex.functions.Predicate<? super T> r2) {
            r0 = this;
            r0.<init>(r1)
            r0.predicate = r2
            return
    ...
    public void subscribeActual(io.reactivex.Observer<? super T> r4) {
            ...
            io.reactivex.internal.operators.observable.ObservableTakeWhile$TakeWhileObserver r1 = new io.reactivex.internal.operators.observable.ObservableTakeWhile$TakeWhileObserver
