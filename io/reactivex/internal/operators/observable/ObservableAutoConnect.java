...
public final class ObservableAutoConnect<T> extends io.reactivex.Observable<T> {
    ...
    public ObservableAutoConnect(io.reactivex.observables.ConnectableObservable<? extends T> r1, int r2, io.reactivex.functions.Consumer<? super io.reactivex.disposables.Disposable> r3) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.numberOfObservers = r2
            r0.connection = r3
    ...
    public void subscribeActual(io.reactivex.Observer<? super T> r2) {
            r1 = this;
            io.reactivex.observables.ConnectableObservable<? extends T> r0 = r1.source
            r0.subscribe(r2)
            java.util.concurrent.atomic.AtomicInteger r2 = r1.clients
            int r2 = r2.incrementAndGet()
            int r0 = r1.numberOfObservers
            if (r2 != r0) goto L16
            io.reactivex.observables.ConnectableObservable<? extends T> r2 = r1.source
