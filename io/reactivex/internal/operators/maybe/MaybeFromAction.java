...
public final class MaybeFromAction<T> extends io.reactivex.Maybe<T> implements java.util.concurrent.Callable<T> {
    ...
    public MaybeFromAction(io.reactivex.functions.Action r1) {
            r0 = this;
            r0.<init>()
            r0.action = r1
            return
    ...
    public T call() throws java.lang.Exception {
            r1 = this;
            io.reactivex.functions.Action r0 = r1.action
            r0.run()
            r0 = 0
            return r0
    }
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super T> r3) {
            ...
            if (r1 != 0) goto L2d
            io.reactivex.functions.Action r1 = r2.action     // Catch: java.lang.Throwable -> L1c
