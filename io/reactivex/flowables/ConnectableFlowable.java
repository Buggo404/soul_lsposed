...
public abstract class ConnectableFlowable<T> extends io.reactivex.Flowable<T> {
    ...
    public io.reactivex.Flowable<T> autoConnect() {
            r1 = this;
            r0 = 1
            io.reactivex.Flowable r0 = r1.autoConnect(r0)
            return r0
    }

    public io.reactivex.Flowable<T> autoConnect(int r2) {
            r1 = this;
            io.reactivex.functions.Consumer r0 = io.reactivex.internal.functions.Functions.emptyConsumer()
            io.reactivex.Flowable r2 = r1.autoConnect(r2, r0)
            return r2
    }

    public io.reactivex.Flowable<T> autoConnect(int r2, io.reactivex.functions.Consumer<? super io.reactivex.disposables.Disposable> r3) {
            r1 = this;
            if (r2 > 0) goto La
            r1.connect(r3)
            io.reactivex.flowables.ConnectableFlowable r2 = io.reactivex.plugins.RxJavaPlugins.onAssembly(r1)
            return r2
        La:
            io.reactivex.internal.operators.flowable.FlowableAutoConnect r0 = new io.reactivex.internal.operators.flowable.FlowableAutoConnect
            r0.<init>(r1, r2, r3)
    ...
    public io.reactivex.Flowable<T> refCount() {
            r1 = this;
            io.reactivex.internal.operators.flowable.FlowableRefCount r0 = new io.reactivex.internal.operators.flowable.FlowableRefCount
            r0.<init>(r1)
    ...
    @io.reactivex.annotations.BackpressureSupport(io.reactivex.annotations.BackpressureKind.PASS_THROUGH)
    @io.reactivex.annotations.CheckReturnValue
    public final io.reactivex.Flowable<T> refCount(int r7) {
            r6 = this;
            r2 = 0
            ...
            r0 = r6
            r1 = r7
            io.reactivex.Flowable r7 = r0.refCount(r1, r2, r4, r5)
            return r7
    }
    ...
    @io.reactivex.annotations.BackpressureSupport(io.reactivex.annotations.BackpressureKind.PASS_THROUGH)
    @io.reactivex.annotations.CheckReturnValue
    public final io.reactivex.Flowable<T> refCount(int r7, long r8, java.util.concurrent.TimeUnit r10) {
            r6 = this;
    ...
    @io.reactivex.annotations.BackpressureSupport(io.reactivex.annotations.BackpressureKind.PASS_THROUGH)
    @io.reactivex.annotations.CheckReturnValue
    public final io.reactivex.Flowable<T> refCount(int r9, long r10, java.util.concurrent.TimeUnit r12, io.reactivex.Scheduler r13) {
            r8 = this;
    ...
    @io.reactivex.annotations.BackpressureSupport(io.reactivex.annotations.BackpressureKind.PASS_THROUGH)
    @io.reactivex.annotations.CheckReturnValue
    public final io.reactivex.Flowable<T> refCount(long r7, java.util.concurrent.TimeUnit r9) {
            r6 = this;
            r1 = 1
            io.reactivex.Scheduler r5 = io.reactivex.schedulers.Schedulers.computation()
            r0 = r6
    ...
    @io.reactivex.annotations.BackpressureSupport(io.reactivex.annotations.BackpressureKind.PASS_THROUGH)
    @io.reactivex.annotations.CheckReturnValue
    public final io.reactivex.Flowable<T> refCount(long r7, java.util.concurrent.TimeUnit r9, io.reactivex.Scheduler r10) {
            r6 = this;
            r1 = 1
            r0 = r6
            r2 = r7
