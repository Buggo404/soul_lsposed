...
public class EncryptedDatabaseStatement implements org.greenrobot.greendao.database.DatabaseStatement {
    private final net.sqlcipher.database.SQLiteStatement delegate;

    public EncryptedDatabaseStatement(net.sqlcipher.database.SQLiteStatement r1) {
            r0 = this;
            r0.<init>()
            r0.delegate = r1
            return
    ...
    public void bindBlob(int r2, byte[] r3) {
            r1 = this;
            net.sqlcipher.database.SQLiteStatement r0 = r1.delegate
            r0.bindBlob(r2, r3)
            return
    }
    ...
    public long executeInsert() {
            r2 = this;
            net.sqlcipher.database.SQLiteStatement r0 = r2.delegate
