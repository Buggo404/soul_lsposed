...
public final class FlowableElementAtMaybe<T> extends io.reactivex.Maybe<T> implements io.reactivex.internal.fuseable.FuseToFlowable<T> {
    ...
    static final class ElementAtSubscriber<T> implements io.reactivex.FlowableSubscriber<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: s */
        org.reactivestreams.Subscription f251s;

        ElementAtSubscriber(io.reactivex.MaybeObserver<? super T> r1, long r2) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.index = r2
        ...
        public void dispose() {
                r1 = this;
                org.reactivestreams.Subscription r0 = r1.f251s
                r0.cancel()
        ...
        public boolean isDisposed() {
                r2 = this;
                org.reactivestreams.Subscription r0 = r2.f251s
        ...
        public void onNext(T r5) {
            ...
            L5:
                ...
                r0 = 1
                r4.done = r0
                org.reactivestreams.Subscription r0 = r4.f251s
                r0.cancel()
                io.reactivex.internal.subscriptions.SubscriptionHelper r0 = io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED
                r4.f251s = r0
    ...
    public FlowableElementAtMaybe(io.reactivex.Flowable<T> r1, long r2) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            r0.index = r2
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super T> r5) {
            ...
            io.reactivex.internal.operators.flowable.FlowableElementAtMaybe$ElementAtSubscriber r1 = new io.reactivex.internal.operators.flowable.FlowableElementAtMaybe$ElementAtSubscriber
            long r2 = r4.index
            r1.<init>(r5, r2)
            r0.subscribe(r1)
            return
