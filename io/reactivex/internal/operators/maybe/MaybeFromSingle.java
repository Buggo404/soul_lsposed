...
public final class MaybeFromSingle<T> extends io.reactivex.Maybe<T> implements io.reactivex.internal.fuseable.HasUpstreamSingleSource<T> {
    ...
    static final class FromSingleObserver<T> implements io.reactivex.SingleObserver<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: d */
        io.reactivex.disposables.Disposable f352d;

        FromSingleObserver(io.reactivex.MaybeObserver<? super T> r1) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                return
        ...
        public void dispose() {
                r1 = this;
                io.reactivex.disposables.Disposable r0 = r1.f352d
                r0.dispose()
    ...
    public MaybeFromSingle(io.reactivex.SingleSource<T> r1) {
            r0 = this;
            r0.<init>()
            r0.source = r1
            return
    ...
    protected void subscribeActual(io.reactivex.MaybeObserver<? super T> r3) {
            ...
            io.reactivex.internal.operators.maybe.MaybeFromSingle$FromSingleObserver r1 = new io.reactivex.internal.operators.maybe.MaybeFromSingle$FromSingleObserver
            r1.<init>(r3)
            r0.subscribe(r1)
            return
    }
