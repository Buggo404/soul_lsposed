...
public final class ObservableRetryWhen<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    final io.reactivex.functions.Function<? super io.reactivex.Observable<java.lang.Throwable>, ? extends io.reactivex.ObservableSource<?>> handler;
    ...
    static final class RepeatWhenObserver<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        /* renamed from: d */
        final java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> f435d;
        final io.reactivex.internal.util.AtomicThrowable error;
        final io.reactivex.internal.operators.observable.ObservableRetryWhen.RepeatWhenObserver<T>.InnerRepeatObserver inner;
        ...
        final class InnerRepeatObserver extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.Observer<java.lang.Object> {
            ...
            final /* synthetic */ io.reactivex.internal.operators.observable.ObservableRetryWhen.RepeatWhenObserver this$0;

            InnerRepeatObserver(io.reactivex.internal.operators.observable.ObservableRetryWhen.RepeatWhenObserver r1) {
                    r0 = this;
                    r0.this$0 = r1
                    r0.<init>()
                    return
            ...
            public void onComplete() {
                    r1 = this;
                    io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver r0 = r1.this$0
                    r0.innerComplete()
                    return
            }
            ...
            public void onNext(java.lang.Object r1) {
                    r0 = this;
                    io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver r1 = r0.this$0
                    r1.innerNext()
                    return
            }
        ...
        RepeatWhenObserver(io.reactivex.Observer<? super T> r1, io.reactivex.subjects.Subject<java.lang.Throwable> r2, io.reactivex.ObservableSource<T> r3) {
                r0 = this;
                r0.<init>()
                r0.actual = r1
                r0.signaller = r2
                ...
                r1.<init>()
                r0.error = r1
                io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver$InnerRepeatObserver r1 = new io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver$InnerRepeatObserver
                r1.<init>(r0)
                r0.inner = r1
        ...
        public void dispose() {
                r1 = this;
                java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r0 = r1.f435d
                io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
                io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver<T>$InnerRepeatObserver r0 = r1.inner
                io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
                return
        }
        ...
        void innerComplete() {
                r2 = this;
                java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r0 = r2.f435d
                io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
        ...
        public void onComplete() {
                r2 = this;
                io.reactivex.internal.operators.observable.ObservableRetryWhen$RepeatWhenObserver<T>$InnerRepeatObserver r0 = r2.inner
                io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
                io.reactivex.Observer<? super T> r0 = r2.actual
                io.reactivex.internal.util.AtomicThrowable r1 = r2.error
                io.reactivex.internal.util.HalfSerializer.onComplete(r0, r2, r1)
        ...
        public void onError(java.lang.Throwable r2) {
                ...
                r0 = 0
                r1.active = r0
                io.reactivex.subjects.Subject<java.lang.Throwable> r0 = r1.signaller
                r0.onNext(r2)
                return
        }
    ...
    public ObservableRetryWhen(io.reactivex.ObservableSource<T> r1, io.reactivex.functions.Function<? super io.reactivex.Observable<java.lang.Throwable>, ? extends io.reactivex.ObservableSource<?>> r2) {
            r0 = this;
            r0.<init>(r1)
            r0.handler = r2
            return
    ...
    protected void subscribeActual(io.reactivex.Observer<? super T> r5) {
            ...
            io.reactivex.functions.Function<? super io.reactivex.Observable<java.lang.Throwable>, ? extends io.reactivex.ObservableSource<?>> r1 = r4.handler     // Catch: java.lang.Throwable -> L29
